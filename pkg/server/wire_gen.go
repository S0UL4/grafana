...
func Initialize(cla setting.CommandLineArgs, opts Options, apiOpts api.ServerOptions) (*Server, error) {
	...
	pluginManager, err := manager.ProvideService(cfg, inMemory, loaderLoader)
	if err != nil {
		return nil, err
	}
	...
	ossRemoteSecretsPluginCheck := kvstore2.ProvideRemotePluginCheck()
	secretsKVStore := kvstore2.ProvideService(sqlStore, secretsService, ossRemoteSecretsPluginCheck)
	...
	service9 := service3.ProvideService(pluginManager, oauthtokenService, serviceService)
	...
	dashboardServiceImpl := service4.ProvideDashboardService(cfg, dashboardStore, dashAlertExtractorService, featureToggles, folderPermissionsService, dashboardPermissionsService, ossAccessControlService)
	alertEngine := alerting.ProvideAlertEngine(renderingService, ossPluginRequestValidator, service9, usageStats, ossencryptionService, notificationService, tracer, sqlStore, cfg, dashAlertExtractorService, dashboardServiceImpl)
	service10 := service5.ProvideService(pluginManager, dashboardServiceImpl)
	...
	serviceImpl := service6.ProvideService(dashboardSnapshotStore, secretsService)
	cleanUpService := cleanup.ProvideService(cfg, serverLockService, shortURLService, sqlStore, queryHistoryService, dashverService, serviceImpl)
	service11 := service7.ProvideService(sqlStore, secretsService)
	plugincontextProvider := plugincontext.ProvideService(cacheService, pluginManager, cacheServiceImpl, serviceService, service11)
	...
	provisioningServiceImpl, err := provisioning.ProvideService(cfg, sqlStore, pluginManager, ossencryptionService, notificationService, dashboardServiceImpl, serviceService, dashboardServiceImpl, alertNotificationService, service11)
	if err != nil {
		return nil, err
	}
	...
	folderServiceImpl := service4.ProvideFolderService(cfg, dashboardServiceImpl, dashboardStore, searchSearchService, featureToggles, folderPermissionsService, ossAccessControlService, inProcBus)
	alertNG, err := ngalert.ProvideService(cfg, cacheServiceImpl, routeRegisterImpl, sqlStore, kvStore, exprService, dataSourceProxyService, quotaService, secretsService, notificationService, ngAlert, folderServiceImpl, ossAccessControlService, dashboardServiceImpl, renderingService, inProcBus)
	if err != nil {
		return nil, err
	}
	...
	teamGuardianStoreImpl := database6.ProvideTeamGuardianStore(sqlStore)
	managerService := manager3.ProvideService(teamGuardianStoreImpl)
	serviceAccountsService, err := manager4.ProvideServiceAccountsService(cfg, featureToggles, sqlStore, kvStore, ossAccessControlService, routeRegisterImpl, usageStats)
	if err != nil {
		return nil, err
	}
	...
	generic, err := registry2.ProvideGeneric()
	if err != nil {
		return nil, err
	}
	static, err := registry2.ProvideStatic()
	if err != nil {
		return nil, err
	}
	httpServer, err := api.ProvideHTTPServer(apiOpts, cfg, routeRegisterImpl, inProcBus, renderingService, ossLicensingService, hooksService, cacheService, sqlStore, alertEngine, ossPluginRequestValidator, pluginManager, service10, pluginManager, pluginManager, loaderLoader, pluginManager, ossImpl, cacheServiceImpl, userAuthTokenService, cleanUpService, shortURLService, queryHistoryService, thumbsService, remoteCache, provisioningServiceImpl, loginserviceImplementation, authenticatorService, ossAccessControlService, dataSourceProxyService, searchSearchService, grafanaLive, gateway, plugincontextProvider, contextHandler, featureManager, alertNG, libraryPanelService, libraryElementService, quotaService, socialService, tracer, exportService, ossencryptionService, grafanaService, pluginsService, ossService, serviceService, secretsService, queryService, ossGroups, managerService, serviceAccountsService, implementation, httpStorageService, notificationService, dashboardServiceImpl, dashboardServiceImpl, folderServiceImpl, ossDatasourcePermissionsService, alertNotificationService, serviceImpl, commentsService, service11, avatarCacheServer, prefService, entityEventsService, teamPermissionsService, folderPermissionsService, dashboardPermissionsService, dashverService, starService, csrfService, generic, static, kvStore)
	if err != nil {
		return nil, err
	}
	...
	importDashboardService := service8.ProvideService(routeRegisterImpl, quotaService, service10, pluginManager, libraryPanelService, dashboardServiceImpl, ossAccessControlService)
	dashboardUpdater := service5.ProvideDashboardUpdater(inProcBus, pluginManager, service10, importDashboardService, service11, dashboardServiceImpl, dashboardServiceImpl)
	backgroundServiceRegistry := backgroundsvcs.ProvideBackgroundServiceRegistry(httpServer, alertNG, cleanUpService, grafanaLive, gateway, notificationService, pluginManager, renderingService, userAuthTokenService, tracer, provisioningServiceImpl, alertEngine, usageStats, statscollectorService, grafanaService, pluginsService, internalMetricsService, secretsService, remoteCache, thumbsService, storageService, searchService, entityEventsService, serviceImpl, alertNotificationService, serviceAccountsService, guardianProvider, dashboardUpdater)
...
func InitializeForTest(cla setting.CommandLineArgs, opts Options, apiOpts api.ServerOptions) (*TestEnv, error) {
	...
	folderServiceImpl := service4.ProvideFolderService(cfg, dashboardServiceImpl, dashboardStore, searchSearchService, featureToggles, folderPermissionsService, ossAccessControlService, inProcBus)
	alertNG, err := ngalert.ProvideService(cfg, cacheServiceImpl, routeRegisterImpl, sqlStore, kvStore, exprService, dataSourceProxyService, quotaService, secretsService, notificationServiceMock, ngAlert, folderServiceImpl, ossAccessControlService, dashboardServiceImpl, renderingService, inProcBus)
	if err != nil {
		return nil, err
	}
	libraryElementService := libraryelements.ProvideService(cfg, sqlStore, routeRegisterImpl, folderServiceImpl)
